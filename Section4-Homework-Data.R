...
matplot(FreeThrowAttempts)
t(FreeThrowAttempts/Games)

Data <- FreeThrowAttempts[]
...
ThrowAccuracy = round(FreeThrows/FreeThrowAttempts, 2)
ThrowAccuracy
matplot(ThrowAccuracy)
t(ThrowAccuracy/Games)
...
Style <-round(Points - FreeThrows, 2) / FieldGoals
...
matplot(t(Data3), type = "b", pch=15:18, col=c(1:4,6))
